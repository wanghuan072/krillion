...
- Footer Legal links are `/privacy`, `/terms`, `/copyright`, `/about`, and `/contact`, use `rel="noopener noreferrer nofollow"`, and remain in the same tab. Contact shows plain text `wyong@testkrillion.com`, with no form or `mailto:` link.
